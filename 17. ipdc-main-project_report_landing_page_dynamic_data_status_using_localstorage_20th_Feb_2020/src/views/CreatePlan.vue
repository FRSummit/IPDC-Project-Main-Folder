...
export default {
    ...
    methods: {
        ...
        createPlan() {
            ...
            unitPlanReportService
                ...
                .then(res => {
                    ...
                    /*if(newPlans > oldPlans) {
                        ...
                        // this.createdPlanStatus = 'Plan Created'
                        // this.$router.push('/planandreports')
                    } else {
                        console.log('Plan already there')
                        this.createdPlanStatus = 'Plan already there'
                        this.hidePlanCreationStatus()
                    }*/
                    this.$router.push('/planandreports')
                })
                .catch(err => {
            ...
            // console.log('getAllPlans : ' + this.getAllPlans());
            // let plns = this.getAllPlans()
