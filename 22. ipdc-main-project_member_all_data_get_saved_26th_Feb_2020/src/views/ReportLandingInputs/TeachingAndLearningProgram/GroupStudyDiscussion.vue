...
export default {
  ...
  methods: {
    onSubmit() {
      ...
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('teachingAndLearningProgram_groupStudyTeachingLearningProgramPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('teachingAndLearningProgram_groupStudyTeachingLearningProgramData', JSON.stringify(post))
      }
      //
    },
    backButton() {
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.groupStudyTeachingLearningProgramPlanData.target
      this.dateAndAction = planData.groupStudyTeachingLearningProgramPlanData.dateAndAction
    }
    if(tabActivationForPlanOrReport === 'REPORT') {
      ...
      this.target = reportData.groupStudyTeachingLearningProgramData.target
      this.dateAndAction = reportData.groupStudyTeachingLearningProgramData.dateAndAction
      this.actual = reportData.groupStudyTeachingLearningProgramData.actual
      this.averageAttendance = reportData.groupStudyTeachingLearningProgramData.averageAttendance
      this.comment = reportData.groupStudyTeachingLearningProgramData.comment
    }
  }
}
</script>
