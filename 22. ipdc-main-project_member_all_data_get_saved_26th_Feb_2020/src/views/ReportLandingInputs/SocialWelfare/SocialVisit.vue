...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('socialWelfare_socialVisitSocialWelfarePlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('socialWelfare_socialVisitSocialWelfareData', JSON.stringify(post))
      }
    },
    backButton() {
      console.log('working')
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.socialVisitSocialWelfarePlanData.target
      this.dateAndAction = planData.socialVisitSocialWelfarePlanData.dateAndAction
    }
    if(tabActivationForPlanOrReport === 'REPORT') {
      ...
      this.target = reportData.socialVisitSocialWelfareData.target
      this.dateAndAction = reportData.socialVisitSocialWelfareData.dateAndAction
      this.actual = reportData.socialVisitSocialWelfareData.actual
      this.comment = reportData.socialVisitSocialWelfareData.comment
    }
  }
}
</script>
