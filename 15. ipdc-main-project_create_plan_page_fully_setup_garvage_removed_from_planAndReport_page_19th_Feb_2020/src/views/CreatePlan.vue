    ...
    methods: {
        myOrganizationSelection(id) {
            ...
            unitPlanReportService
                ...
                .then(res => {
                    console.log(res)
                    this.createPlanOrganizationReference = res.data[0].organizationReference; // get infos for creating plan (organizationReference informations, year, reporting term and frequencies) which is selected
        ...
        createPlan() {
            ...
            const OrganizationReference = {
                            organization:
                                {
                                    id: this.createPlanOrganizationReference.id,                                            // get this from createPlanOrganizationReference
                                    organizationType: this.createPlanOrganizationReference.organizationType,                // get this from createPlanOrganizationReference
                                    description: this.createPlanOrganizationReference.description,                          // get this from createPlanOrganizationReference
                                    reportingFrequency: this.createPlanOrganizationReference.reportingFrequency,            // get this from createPlanOrganizationReference
                                    details: this.createPlanOrganizationReference.details                                   // get this from createPlanOrganizationReference
                                },
                            year: this.createPlanOrgYear,                                                                                     // get this from selectedReportingPeriods
                            reportingTerm: this.reportingFrequencySelectionNumber(orgReportingTerm),                                                                               // get this from selectedReportingPeriods
                            reportingFrequency: this.createPlanOrganizationReference.reportingFrequency                     // get this from createPlanOrganizationReference
            };
