...
export default class PostService{
    ...
    updatePlan(plan, accessToken) {
        console.log('plan update working' + plan.target)
        console.log('plan update working' + plan.nameAndContactNumber)
        console.log('plan update working' + plan.action)
        return axios(URL_PLAN_UPDATE_BASE + '20' 
                                    + '&planId=' + '1062', {
            headers: {
                   Authorization: 'Bearer ' + accessToken,
                   'SignalRConnectionId': '8ce05f33-570c-4b0c-9abd-b2252d3fcc08',
            ...
            data: 
                {
                    ...
                    "memberMemberPlanData":
                        {
                            "nameAndContactNumber":plan.target,
                            "action":plan.nameAndContactNumber,
                            "upgradeTarget":plan.action
                        },
