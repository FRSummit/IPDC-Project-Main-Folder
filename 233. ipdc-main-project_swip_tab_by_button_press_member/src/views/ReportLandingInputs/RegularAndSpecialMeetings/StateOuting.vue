...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_stateOutingMeetingProgramPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_stateOutingMeetingProgramData', JSON.stringify(post))
      }
    },
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.stateOutingMeetingProgramPlanData.target
      this.dateAndAction = planData.stateOutingMeetingProgramPlanData.dateAndAction
      ...
      this.target = reportData.stateOutingMeetingProgramData.target
      this.dateAndAction = reportData.stateOutingMeetingProgramData.dateAndAction
      this.actual = reportData.stateOutingMeetingProgramData.actual
      this.averageAttendance = reportData.stateOutingMeetingProgramData.averageAttendance
      this.comment = reportData.stateOutingMeetingProgramData.comment
    }
  }
}
</script>
