...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_tafsirMeetingProgramPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_tafsirMeetingProgramData', JSON.stringify(post))
      }
    },
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.tafsirMeetingProgramPlanData.target
      this.dateAndAction = planData.tafsirMeetingProgramPlanData.dateAndAction
      ...
      this.target = reportData.tafsirMeetingProgramData.target
      this.dateAndAction = reportData.tafsirMeetingProgramData.dateAndAction
      this.actual = reportData.tafsirMeetingProgramData.actual
      this.averageAttendance = reportData.tafsirMeetingProgramData.averageAttendance
      this.comment = reportData.tafsirMeetingProgramData.comment
    }
  }
}
</script>
