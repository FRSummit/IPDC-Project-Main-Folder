...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_smMeetingProgramPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_smMeetingProgramData', JSON.stringify(post))
      }
    },
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.smMeetingProgramPlanData.target
      this.dateAndAction = planData.smMeetingProgramPlanData.dateAndAction
      ...
      this.target = reportData.smMeetingProgramData.target
      this.dateAndAction = reportData.smMeetingProgramData.dateAndAction
      this.actual = reportData.smMeetingProgramData.actual
      this.averageAttendance = reportData.smMeetingProgramData.averageAttendance
      this.comment = reportData.smMeetingProgramData.comment
    }
  }
}
</script>
