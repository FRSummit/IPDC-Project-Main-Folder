...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_workerMeetingProgramPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_workerMeetingProgramData', JSON.stringify(post))
      }
    },
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.workerMeetingProgramPlanData.target
      this.dateAndAction = planData.workerMeetingProgramPlanData.dateAndAction
      ...
      this.target = reportData.workerMeetingProgramData.target
      this.dateAndAction = reportData.workerMeetingProgramData.dateAndAction
      this.actual = reportData.workerMeetingProgramData.actual
      this.averageAttendance = reportData.workerMeetingProgramData.averageAttendance
      this.comment = reportData.workerMeetingProgramData.comment
    }
  }
}
</script>
