...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_socialDawahMeetingProgramPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_socialDawahMeetingProgramData', JSON.stringify(post))
      }
    },
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.socialDawahMeetingProgramPlanData.target
      this.dateAndAction = planData.socialDawahMeetingProgramPlanData.dateAndAction
      ...
      this.target = reportData.socialDawahMeetingProgramData.target
      this.dateAndAction = reportData.socialDawahMeetingProgramData.dateAndAction
      this.actual = reportData.socialDawahMeetingProgramData.actual
      this.averageAttendance = reportData.socialDawahMeetingProgramData.averageAttendance
      this.comment = reportData.socialDawahMeetingProgramData.comment
    }
  }
}
</script>
