...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_unitMeetingProgramPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_unitMeetingProgramData', JSON.stringify(post))
      }
    },
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.unitMeetingProgramPlanData.target
      this.dateAndAction = planData.unitMeetingProgramPlanData.dateAndAction
      ...
      this.target = reportData.unitMeetingProgramData.target
      this.dateAndAction = reportData.unitMeetingProgramData.dateAndAction
      this.actual = reportData.unitMeetingProgramData.actual
      this.averageAttendance = reportData.unitMeetingProgramData.averageAttendance
      this.comment = reportData.unitMeetingProgramData.comment
    }
  }
}
</script>
