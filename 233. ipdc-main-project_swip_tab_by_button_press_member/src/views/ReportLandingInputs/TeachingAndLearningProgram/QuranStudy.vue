...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('teachingAndLearningProgram_quranStudyTeachingLearningProgramPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('teachingAndLearningProgram_quranStudyTeachingLearningProgramData', JSON.stringify(post))
      }
    },
    backButton() {
      console.log('working')
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.quranStudyTeachingLearningProgramPlanData.target
      this.dateAndAction = planData.quranStudyTeachingLearningProgramPlanData.dateAndAction
    }
    if(tabActivationForPlanOrReport === 'REPORT') {
      ...
      this.target = reportData.quranStudyTeachingLearningProgramData.target
      this.dateAndAction = reportData.quranStudyTeachingLearningProgramData.dateAndAction
      this.actual = reportData.quranStudyTeachingLearningProgramData.actual
      this.averageAttendance = reportData.quranStudyTeachingLearningProgramData.averageAttendance
      this.comment = reportData.quranStudyTeachingLearningProgramData.comment
    }
  }
}
</script>
