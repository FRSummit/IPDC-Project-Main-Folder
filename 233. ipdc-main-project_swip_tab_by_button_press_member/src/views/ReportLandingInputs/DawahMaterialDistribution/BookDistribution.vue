...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('dawahMaterialDistribution_bookDistributionMaterialPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('dawahMaterialDistribution_bookDistributionMaterialData', JSON.stringify(post))
      }
    },
    backButton() {
      console.log('working')
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.bookDistributionMaterialPlanData.target
      this.dateAndAction = planData.bookDistributionMaterialPlanData.dateAndAction
      ...
      this.target = reportData.bookDistributionMaterialData.target
      this.dateAndAction = reportData.bookDistributionMaterialData.dateAndAction
      this.actual = reportData.bookDistributionMaterialData.actual
      this.comment = reportData.bookDistributionMaterialData.comment
    }
  }
}
</script>
