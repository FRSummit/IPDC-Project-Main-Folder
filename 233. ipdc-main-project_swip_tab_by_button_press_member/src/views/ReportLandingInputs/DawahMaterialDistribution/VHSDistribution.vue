    ...
    <div class="content-div">
      <form class="form-cls" @submit.prevent="onSubmit">
        <v-subheader class="content-header">
          ...
          VHS/DVD/VCD/CD/Audio Distribution
        </v-subheader>
...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('dawahMaterialDistribution_vhsDistributionMaterialPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('dawahMaterialDistribution_vhsDistributionMaterialData', JSON.stringify(post))
      }
    },
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.vhsDistributionMaterialPlanData.target
      this.dateAndAction = planData.vhsDistributionMaterialPlanData.dateAndAction
      ...
      this.target = reportData.vhsDistributionMaterialData.target
      this.dateAndAction = reportData.vhsDistributionMaterialData.dateAndAction
      this.actual = reportData.vhsDistributionMaterialData.actual
      this.comment = reportData.vhsDistributionMaterialData.comment
    }
  }
}
</script>
