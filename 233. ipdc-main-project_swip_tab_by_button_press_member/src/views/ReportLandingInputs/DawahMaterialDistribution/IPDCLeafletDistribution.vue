  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('dawahMaterialDistribution_ipdcLeafletDistributionMaterialPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('dawahMaterialDistribution_ipdcLeafletDistributionMaterialData', JSON.stringify(post))
      }
    },
    backButton() {
      console.log('working')
