...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_dawahMeetingProgramPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_dawahMeetingProgramData', JSON.stringify(post))
      }
    },
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.dawahMeetingProgramPlanData.target
      this.dateAndAction = planData.dawahMeetingProgramPlanData.dateAndAction
      ...
      this.target = reportData.dawahMeetingProgramData.target
      this.dateAndAction = reportData.dawahMeetingProgramData.dateAndAction
      this.actual = reportData.dawahMeetingProgramData.actual
      this.averageAttendance = reportData.dawahMeetingProgramData.averageAttendance
      this.comment = reportData.dawahMeetingProgramData.comment
    }
  }
}
</script>
