...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_stateLeaderMeetingProgramPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_stateLeaderMeetingProgramData', JSON.stringify(post))
      }
    },
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.stateLeaderMeetingProgramPlanData.target
      this.dateAndAction = planData.stateLeaderMeetingProgramPlanData.dateAndAction
      ...
      this.target = reportData.stateLeaderMeetingProgramData.target
      this.dateAndAction = reportData.stateLeaderMeetingProgramData.dateAndAction
      this.actual = reportData.stateLeaderMeetingProgramData.actual
      this.averageAttendance = reportData.stateLeaderMeetingProgramData.averageAttendance
      this.comment = reportData.stateLeaderMeetingProgramData.comment
    }
  }
}
</script>
