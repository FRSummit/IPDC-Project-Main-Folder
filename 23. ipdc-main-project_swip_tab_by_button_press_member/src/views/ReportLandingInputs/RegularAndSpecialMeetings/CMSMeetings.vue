...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_cmsMeetingProgramPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_cmsMeetingProgramData', JSON.stringify(post))
      }
    },
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.cmsMeetingProgramPlanData.target
      this.dateAndAction = planData.cmsMeetingProgramPlanData.dateAndAction
      ...
      this.target = reportData.cmsMeetingProgramData.target
      this.dateAndAction = reportData.cmsMeetingProgramData.dateAndAction
      this.actual = reportData.cmsMeetingProgramData.actual
      this.averageAttendance = reportData.cmsMeetingProgramData.averageAttendance
      this.comment = reportData.cmsMeetingProgramData.comment
    }
  }
}
</script>
