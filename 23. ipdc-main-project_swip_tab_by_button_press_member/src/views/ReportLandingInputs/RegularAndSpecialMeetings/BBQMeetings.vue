...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_bbqMeetingProgramPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_bbqMeetingProgramData', JSON.stringify(post))
      }
    },
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.bbqMeetingProgramPlanData.target
      this.dateAndAction = planData.bbqMeetingProgramPlanData.dateAndAction
      ...
      this.target = reportData.bbqMeetingProgramData.target
      this.dateAndAction = reportData.bbqMeetingProgramData.dateAndAction
      this.actual = reportData.bbqMeetingProgramData.actual
      this.averageAttendance = reportData.bbqMeetingProgramData.averageAttendance
      this.comment = reportData.bbqMeetingProgramData.comment
    }
  }
}
</script>
