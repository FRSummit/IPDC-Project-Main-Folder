...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_iftarMeetingProgramPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_iftarMeetingProgramData', JSON.stringify(post))
      }
    },
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.iftarMeetingProgramPlanData.target
      this.dateAndAction = planData.iftarMeetingProgramPlanData.dateAndAction
      ...
      this.target = reportData.iftarMeetingProgramData.target
      this.dateAndAction = reportData.iftarMeetingProgramData.dateAndAction
      this.actual = reportData.iftarMeetingProgramData.actual
      this.averageAttendance = reportData.iftarMeetingProgramData.averageAttendance
      this.comment = reportData.iftarMeetingProgramData.comment
    }
  }
}
</script>
