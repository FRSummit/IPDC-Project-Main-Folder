...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_familyVisitMeetingProgramPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_familyVisitMeetingProgramData', JSON.stringify(post))
      }
    },
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.familyVisitMeetingProgramPlanData.target
      this.dateAndAction = planData.familyVisitMeetingProgramPlanData.dateAndAction
      ...
      this.target = reportData.familyVisitMeetingProgramData.target
      this.dateAndAction = reportData.familyVisitMeetingProgramData.dateAndAction
      this.actual = reportData.familyVisitMeetingProgramData.actual
      this.averageAttendance = reportData.familyVisitMeetingProgramData.averageAttendance
      this.comment = reportData.familyVisitMeetingProgramData.comment
    }
  }
}
</script>
