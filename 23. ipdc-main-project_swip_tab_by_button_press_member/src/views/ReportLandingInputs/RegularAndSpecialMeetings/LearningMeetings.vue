...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_learningMeetingProgramPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_learningMeetingProgramData', JSON.stringify(post))
      }
    },
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.learningMeetingProgramPlanData.target
      this.dateAndAction = planData.learningMeetingProgramPlanData.dateAndAction
      ...
      this.target = reportData.learningMeetingProgramData.target
      this.dateAndAction = reportData.learningMeetingProgramData.dateAndAction
      this.actual = reportData.learningMeetingProgramData.actual
      this.averageAttendance = reportData.learningMeetingProgramData.averageAttendance
      this.comment = reportData.learningMeetingProgramData.comment
    }
  }
}
</script>
