...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_gatheringMeetingProgramPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_gatheringMeetingProgramData', JSON.stringify(post))
      }
    },
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.gatheringMeetingProgramPlanData.target
      this.dateAndAction = planData.gatheringMeetingProgramPlanData.dateAndAction
      ...
      this.target = reportData.gatheringMeetingProgramData.target
      this.dateAndAction = reportData.gatheringMeetingProgramData.dateAndAction
      this.actual = reportData.gatheringMeetingProgramData.actual
      this.averageAttendance = reportData.gatheringMeetingProgramData.averageAttendance
      this.comment = reportData.gatheringMeetingProgramData.comment
    }
  }
}
</script>
