...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_eidReunionMeetingProgramPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_eidReunionMeetingProgramData', JSON.stringify(post))
      }
    },
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.eidReunionMeetingProgramPlanData.target
      this.dateAndAction = planData.eidReunionMeetingProgramPlanData.dateAndAction
      ...
      this.target = reportData.eidReunionMeetingProgramData.target
      this.dateAndAction = reportData.eidReunionMeetingProgramData.dateAndAction
      this.actual = reportData.eidReunionMeetingProgramData.actual
      this.averageAttendance = reportData.eidReunionMeetingProgramData.averageAttendance
      this.comment = reportData.eidReunionMeetingProgramData.comment
    }
  }
}
</script>
