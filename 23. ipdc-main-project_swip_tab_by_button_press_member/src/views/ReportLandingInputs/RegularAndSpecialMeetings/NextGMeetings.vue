...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_nextGMeetingProgramPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_nextGMeetingProgramData', JSON.stringify(post))
      }
    },
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.nextGMeetingProgramPlanData.target
      this.dateAndAction = planData.nextGMeetingProgramPlanData.dateAndAction
      ...
      this.target = reportData.nextGMeetingProgramData.target
      this.dateAndAction = reportData.nextGMeetingProgramData.dateAndAction
      this.actual = reportData.nextGMeetingProgramData.actual
      this.averageAttendance = reportData.nextGMeetingProgramData.averageAttendance
      this.comment = reportData.nextGMeetingProgramData.comment
    }
  }
}
</script>
