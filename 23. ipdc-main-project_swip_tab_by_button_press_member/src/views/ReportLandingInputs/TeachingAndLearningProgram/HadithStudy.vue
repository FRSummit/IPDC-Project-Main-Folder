...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('teachingAndLearningProgram_hadithTeachingLearningProgramPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('teachingAndLearningProgram_hadithTeachingLearningProgramData', JSON.stringify(post))
      }
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.hadithTeachingLearningProgramPlanData.target
      this.dateAndAction = planData.hadithTeachingLearningProgramPlanData.dateAndAction
    }
    if(tabActivationForPlanOrReport === 'REPORT') {
      ...
      this.target = reportData.hadithTeachingLearningProgramData.target
      this.dateAndAction = reportData.hadithTeachingLearningProgramData.dateAndAction
      this.actual = reportData.hadithTeachingLearningProgramData.actual
      this.averageAttendance = reportData.hadithTeachingLearningProgramData.averageAttendance
      this.comment = reportData.hadithTeachingLearningProgramData.comment
    }
  }
}
</script>
