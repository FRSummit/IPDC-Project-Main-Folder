...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('teachingAndLearningProgram_stateLearningCampTeachingLearningProgramPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('teachingAndLearningProgram_stateLearningCampTeachingLearningProgramData', JSON.stringify(post))
      }
    },
    backButton() {
      console.log('working')
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.stateLearningCampTeachingLearningProgramPlanData.target
      this.dateAndAction = planData.stateLearningCampTeachingLearningProgramPlanData.dateAndAction
    }
    if(tabActivationForPlanOrReport === 'REPORT') {
      ...
      this.target = reportData.stateLearningCampTeachingLearningProgramData.target
      this.dateAndAction = reportData.stateLearningCampTeachingLearningProgramData.dateAndAction
      this.actual = reportData.stateLearningCampTeachingLearningProgramData.actual
      this.averageAttendance = reportData.stateLearningCampTeachingLearningProgramData.averageAttendance
      this.comment = reportData.stateLearningCampTeachingLearningProgramData.comment
    }
  }
}
</script>
