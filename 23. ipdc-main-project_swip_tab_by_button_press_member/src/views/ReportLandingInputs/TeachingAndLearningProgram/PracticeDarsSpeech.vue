...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('teachingAndLearningProgram_practiceDarsTeachingLearningProgramPlanData', JSON.stringify(post))
      } 
      if(this.planOrReportTab === 'REPORT') {
        ...
        console.log(post)
        localStorage.setItem('teachingAndLearningProgram_practiceDarsTeachingLearningProgramData', JSON.stringify(post))
      }
    },
    backButton() {
      console.log('working')
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.practiceDarsTeachingLearningProgramPlanData.target
      this.dateAndAction = planData.practiceDarsTeachingLearningProgramPlanData.dateAndAction
    }
    if(tabActivationForPlanOrReport === 'REPORT') {
      ...
      this.target = reportData.practiceDarsTeachingLearningProgramData.target
      this.dateAndAction = reportData.practiceDarsTeachingLearningProgramData.dateAndAction
      this.actual = reportData.practiceDarsTeachingLearningProgramData.actual
      this.averageAttendance = reportData.practiceDarsTeachingLearningProgramData.averageAttendance
      this.comment = reportData.practiceDarsTeachingLearningProgramData.comment
    }
  }
}
</script>
