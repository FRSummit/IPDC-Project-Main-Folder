    ...
    <div class="content-div">
      <form class="form-cls" @submit.prevent="onSubmit">
        ...
        <v-row class="form-row">
          ...
          <v-col cols="12" class="col-field" v-if="planOrReportTab === 'REPORT'">
            <input name="averageAttendance" v-model="averageAttendance" label="Average Attendance" placeholder="Average Attendance" single-line/>
          </v-col>
          <v-col cols="12" class="col-field" v-if="planOrReportTab === 'REPORT'">
...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('teachingAndLearningProgram_studyCircleForAssociateMemberTeachingLearningProgramPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('teachingAndLearningProgram_studyCircleForAssociateMemberTeachingLearningProgramData', JSON.stringify(post))
      }
    },
    backButton() {
      console.log('working')
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.studyCircleForAssociateMemberTeachingLearningProgramPlanData.target
      this.dateAndAction = planData.studyCircleForAssociateMemberTeachingLearningProgramPlanData.dateAndAction
    }
    if(tabActivationForPlanOrReport === 'REPORT') {
      ...
      this.target = reportData.studyCircleForAssociateMemberTeachingLearningProgramData.target
      this.dateAndAction = reportData.studyCircleForAssociateMemberTeachingLearningProgramData.dateAndAction
      this.actual = reportData.studyCircleForAssociateMemberTeachingLearningProgramData.actual
      this.averageAttendance = reportData.studyCircleForAssociateMemberTeachingLearningProgramData.averageAttendance
      this.comment = reportData.studyCircleForAssociateMemberTeachingLearningProgramData.comment
    }
  }
}
</script>
