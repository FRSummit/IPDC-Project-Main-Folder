...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('teachingAndLearningProgram_memorizingAyatTeachingLearningProgramPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('teachingAndLearningProgram_memorizingAyatTeachingLearningProgramData', JSON.stringify(post))
      }
    },
    backButton() {
      console.log('working')
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.memorizingAyatTeachingLearningProgramPlanData.target
      this.dateAndAction = planData.memorizingAyatTeachingLearningProgramPlanData.dateAndAction
    }
    if(tabActivationForPlanOrReport === 'REPORT') {
      ...
      this.target = reportData.memorizingAyatTeachingLearningProgramData.target
      this.dateAndAction = reportData.memorizingAyatTeachingLearningProgramData.dateAndAction
      this.actual = reportData.memorizingAyatTeachingLearningProgramData.actual
      this.averageAttendance = reportData.memorizingAyatTeachingLearningProgramData.averageAttendance
      this.comment = reportData.memorizingAyatTeachingLearningProgramData.comment
    }
  }
}
</script>
