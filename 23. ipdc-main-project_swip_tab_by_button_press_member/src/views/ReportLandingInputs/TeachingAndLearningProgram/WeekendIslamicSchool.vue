...
export default {
  ...
  methods: {
    onSubmit() {
      ...
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('teachingAndLearningProgram_weekendIslamicSchoolTeachingLearningProgramPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('teachingAndLearningProgram_weekendIslamicSchoolTeachingLearningProgramData', JSON.stringify(post))
      }
      //
    },
    backButton() {
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.weekendIslamicSchoolTeachingLearningProgramPlanData.target
      this.dateAndAction = planData.weekendIslamicSchoolTeachingLearningProgramPlanData.dateAndAction
    }
    if(tabActivationForPlanOrReport === 'REPORT') {
      ...
      this.target = reportData.weekendIslamicSchoolTeachingLearningProgramData.target
      this.dateAndAction = reportData.weekendIslamicSchoolTeachingLearningProgramData.dateAndAction
      this.actual = reportData.weekendIslamicSchoolTeachingLearningProgramData.actual
      this.averageAttendance = reportData.weekendIslamicSchoolTeachingLearningProgramData.averageAttendance
      this.comment = reportData.weekendIslamicSchoolTeachingLearningProgramData.comment
    }
  }
}
</script>
