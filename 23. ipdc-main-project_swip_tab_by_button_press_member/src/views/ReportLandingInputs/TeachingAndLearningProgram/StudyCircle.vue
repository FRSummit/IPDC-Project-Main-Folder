...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('teachingAndLearningProgram_studyCircleTeachingLearningProgramPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('teachingAndLearningProgram_studyCircleTeachingLearningProgramData', JSON.stringify(post))
      }
    },
    backButton() {
      console.log('working')
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.studyCircleTeachingLearningProgramPlanData.target
      this.dateAndAction = planData.studyCircleTeachingLearningProgramPlanData.dateAndAction
    }
    if(tabActivationForPlanOrReport === 'REPORT') {
      ...
      this.target = reportData.studyCircleTeachingLearningProgramData.target
      this.dateAndAction = reportData.studyCircleTeachingLearningProgramData.dateAndAction
      this.actual = reportData.studyCircleTeachingLearningProgramData.actual
      this.averageAttendance = reportData.studyCircleTeachingLearningProgramData.averageAttendance
      this.comment = reportData.studyCircleTeachingLearningProgramData.comment
    }
  }
}
</script>
