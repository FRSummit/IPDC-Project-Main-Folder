...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('teachingAndLearningProgram_stateQiyamulLailTeachingLearningProgramPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('teachingAndLearningProgram_stateQiyamulLailTeachingLearningProgramData', JSON.stringify(post))
      }
    },
    backButton() {
      console.log('working')
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.stateQiyamulLailTeachingLearningProgramPlanData.target
      this.dateAndAction = planData.stateQiyamulLailTeachingLearningProgramPlanData.dateAndAction
    }
    if(tabActivationForPlanOrReport === 'REPORT') {
      ...
      this.target = reportData.stateQiyamulLailTeachingLearningProgramData.target
      this.dateAndAction = reportData.stateQiyamulLailTeachingLearningProgramData.dateAndAction
      this.actual = reportData.stateQiyamulLailTeachingLearningProgramData.actual
      this.averageAttendance = reportData.stateQiyamulLailTeachingLearningProgramData.averageAttendance
      this.comment = reportData.stateQiyamulLailTeachingLearningProgramData.comment
    }
  }
}
</script>
