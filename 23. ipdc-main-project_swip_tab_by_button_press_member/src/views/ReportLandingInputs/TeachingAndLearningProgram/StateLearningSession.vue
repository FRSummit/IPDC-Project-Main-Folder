...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('teachingAndLearningProgram_stateLearningSessionTeachingLearningProgramPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('teachingAndLearningProgram_stateLearningSessionTeachingLearningProgramData', JSON.stringify(post))
      }
    },
    backButton() {
      console.log('working')
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.stateLearningSessionTeachingLearningProgramPlanData.target
      this.dateAndAction = planData.stateLearningSessionTeachingLearningProgramPlanData.dateAndAction
    }
    if(tabActivationForPlanOrReport === 'REPORT') {
      ...
      this.target = reportData.stateLearningSessionTeachingLearningProgramData.target
      this.dateAndAction = reportData.stateLearningSessionTeachingLearningProgramData.dateAndAction
      this.actual = reportData.stateLearningSessionTeachingLearningProgramData.actual
      this.averageAttendance = reportData.stateLearningSessionTeachingLearningProgramData.averageAttendance
      this.comment = reportData.stateLearningSessionTeachingLearningProgramData.comment
    }
  }
}
</script>
