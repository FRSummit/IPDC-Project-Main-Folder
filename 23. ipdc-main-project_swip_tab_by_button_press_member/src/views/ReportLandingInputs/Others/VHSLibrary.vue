...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('others_vhsLibraryStockPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('others_vhsLibraryStockData', JSON.stringify(post))
      }
    },
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.lastPeriod = reportData.vhsLibraryStockData.lastPeriod
      this.thisPeriod = reportData.vhsLibraryStockData.thisPeriod
      this.increased = reportData.vhsLibraryStockData.increased
      this.decreased = reportData.vhsLibraryStockData.decreased
      this.comment = reportData.vhsLibraryStockData.comment
    }
  }
}
</script>
