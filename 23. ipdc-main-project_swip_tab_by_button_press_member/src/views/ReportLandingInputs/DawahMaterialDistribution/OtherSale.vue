...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('dawahMaterialDistribution_otherSaleMaterialPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('dawahMaterialDistribution_otherSaleMaterialData', JSON.stringify(post))
      }
    },
    backButton() {
      console.log('working')
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.otherSaleMaterialPlanData.target
      this.dateAndAction = planData.otherSaleMaterialPlanData.dateAndAction
      ...
      this.target = reportData.otherSaleMaterialData.target
      this.dateAndAction = reportData.otherSaleMaterialData.dateAndAction
      this.actual = reportData.otherSaleMaterialData.actual
      this.comment = reportData.otherSaleMaterialData.comment
    }
  }
}
</script>
