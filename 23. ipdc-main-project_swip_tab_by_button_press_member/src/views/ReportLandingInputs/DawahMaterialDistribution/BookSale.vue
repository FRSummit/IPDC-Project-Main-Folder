...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('dawahMaterialDistribution_bookSaleMaterialPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('dawahMaterialDistribution_bookSaleMaterialData', JSON.stringify(post))
      }
    },
    backButton() {
      console.log('working')
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.bookSaleMaterialPlanData.target
      this.dateAndAction = planData.bookSaleMaterialPlanData.dateAndAction
      ...
      this.target = reportData.bookSaleMaterialData.target
      this.dateAndAction = reportData.bookSaleMaterialData.dateAndAction
      this.actual = reportData.bookSaleMaterialData.actual
      this.comment = reportData.bookSaleMaterialData.comment
    }
  }
}
</script>
