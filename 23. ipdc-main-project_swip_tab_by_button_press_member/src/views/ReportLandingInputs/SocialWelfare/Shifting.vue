...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('socialWelfare_shiftingSocialWelfarePlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('socialWelfare_shiftingSocialWelfareData', JSON.stringify(post))
      }
    },
    backButton() {
      console.log('working')
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.shiftingSocialWelfarePlanData.target
      this.dateAndAction = planData.shiftingSocialWelfarePlanData.dateAndAction
    }
    if(tabActivationForPlanOrReport === 'REPORT') {
      ...
      this.target = reportData.shiftingSocialWelfareData.target
      this.dateAndAction = reportData.shiftingSocialWelfareData.dateAndAction
      this.actual = reportData.shiftingSocialWelfareData.actual
      this.comment = reportData.shiftingSocialWelfareData.comment
    }
  }
}
</script>
