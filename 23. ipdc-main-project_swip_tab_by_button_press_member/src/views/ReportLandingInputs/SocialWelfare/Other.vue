...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('socialWelfare_otherSocialWelfarePlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('socialWelfare_otherSocialWelfareData', JSON.stringify(post))
      }
    },
    backButton() {
      console.log('working')
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.otherSocialWelfarePlanData.target
      this.dateAndAction = planData.otherSocialWelfarePlanData.dateAndAction
    }
    if(tabActivationForPlanOrReport === 'REPORT') {
      ...
      this.target = reportData.otherSocialWelfareData.target
      this.dateAndAction = reportData.otherSocialWelfareData.dateAndAction
      this.actual = reportData.otherSocialWelfareData.actual
      this.comment = reportData.otherSocialWelfareData.comment
    }
  }
}
</script>
