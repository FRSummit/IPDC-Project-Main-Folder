...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('socialWelfare_qardeHasanaSocialWelfarePlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('socialWelfare_qardeHasanaSocialWelfareData', JSON.stringify(post))
      }
    },
    backButton() {
      console.log('working')
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.qardeHasanaSocialWelfarePlanData.target
      this.dateAndAction = planData.qardeHasanaSocialWelfarePlanData.dateAndAction
    }
    if(tabActivationForPlanOrReport === 'REPORT') {
      ...
      this.target = reportData.qardeHasanaSocialWelfareData.target
      this.dateAndAction = reportData.qardeHasanaSocialWelfareData.dateAndAction
      this.actual = reportData.qardeHasanaSocialWelfareData.actual
      this.comment = reportData.qardeHasanaSocialWelfareData.comment
    }
  }
}
</script>
