...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('socialWelfare_shoppingSocialWelfarePlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('socialWelfare_shoppingSocialWelfareData', JSON.stringify(post))
      }
    },
    backButton() {
      console.log('working')
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.shoppingSocialWelfarePlanData.target
      this.dateAndAction = planData.shoppingSocialWelfarePlanData.dateAndAction
    }
    if(tabActivationForPlanOrReport === 'REPORT') {
      ...
      this.target = reportData.shoppingSocialWelfareData.target
      this.dateAndAction = reportData.shoppingSocialWelfareData.dateAndAction
      this.actual = reportData.shoppingSocialWelfareData.actual
      this.comment = reportData.shoppingSocialWelfareData.comment
    }
  }
}
</script>
