...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('socialWelfare_cleanUpAustraliaSocialWelfarePlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('socialWelfare_cleanUpAustraliaSocialWelfareData', JSON.stringify(post))
      }
    },
    backButton() {
      console.log('working')
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.cleanUpAustraliaSocialWelfarePlanData.target
      this.dateAndAction = planData.cleanUpAustraliaSocialWelfarePlanData.dateAndAction
    }
    if(tabActivationForPlanOrReport === 'REPORT') {
      ...
      this.target = reportData.cleanUpAustraliaSocialWelfareData.target
      this.dateAndAction = reportData.cleanUpAustraliaSocialWelfareData.dateAndAction
      this.actual = reportData.cleanUpAustraliaSocialWelfareData.actual
      this.comment = reportData.cleanUpAustraliaSocialWelfareData.comment
    }
  }
}
</script>
