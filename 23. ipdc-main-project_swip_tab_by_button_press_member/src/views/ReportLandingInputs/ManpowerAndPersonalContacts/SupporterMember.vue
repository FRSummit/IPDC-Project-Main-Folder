  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('manpowerAndPersonalContacts_supporterMemberPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('manpowerAndPersonalContacts_supporterMemberData', JSON.stringify(post))
      }
    },
    backButton() {
      console.log('working')
