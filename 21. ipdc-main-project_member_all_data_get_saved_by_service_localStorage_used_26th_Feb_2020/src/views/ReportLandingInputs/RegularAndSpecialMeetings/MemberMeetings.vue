...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_memberMeetingProgramPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_memberMeetingProgramData', JSON.stringify(post))
      }
    },
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.memberMeetingProgramPlanData.target
      this.dateAndAction = planData.memberMeetingProgramPlanData.dateAndAction
      ...
      this.target = reportData.memberMeetingProgramData.target
      this.dateAndAction = reportData.memberMeetingProgramData.dateAndAction
      this.actual = reportData.memberMeetingProgramData.actual
      this.averageAttendance = reportData.memberMeetingProgramData.averageAttendance
      this.comment = reportData.memberMeetingProgramData.comment
    }
  }
}
</script>
