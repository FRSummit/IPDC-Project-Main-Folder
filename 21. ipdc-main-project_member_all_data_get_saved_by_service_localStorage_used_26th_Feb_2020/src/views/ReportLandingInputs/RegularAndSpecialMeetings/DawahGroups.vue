...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_dawahGroupMeetingProgramPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('regularAndSpecialMeetings_dawahGroupMeetingProgramData', JSON.stringify(post))
      }
    },
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.dawahGroupMeetingProgramPlanData.target
      this.dateAndAction = planData.dawahGroupMeetingProgramPlanData.dateAndAction
      ...
      this.target = reportData.dawahGroupMeetingProgramData.target
      this.dateAndAction = reportData.dawahGroupMeetingProgramData.dateAndAction
      this.actual = reportData.dawahGroupMeetingProgramData.actual
      this.averageAttendance = reportData.dawahGroupMeetingProgramData.averageAttendance
      this.comment = reportData.dawahGroupMeetingProgramData.comment
    }
  }
}
</script>
