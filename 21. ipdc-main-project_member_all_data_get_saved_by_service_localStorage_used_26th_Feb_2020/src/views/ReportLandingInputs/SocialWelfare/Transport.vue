...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('socialWelfare_transportSocialWelfarePlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('socialWelfare_transportSocialWelfareData', JSON.stringify(post))
      }
    },
    backButton() {
      console.log('working')
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.transportSocialWelfarePlanData.target
      this.dateAndAction = planData.transportSocialWelfarePlanData.dateAndAction
    }
    if(tabActivationForPlanOrReport === 'REPORT') {
      ...
      this.target = reportData.transportSocialWelfareData.target
      this.dateAndAction = reportData.transportSocialWelfareData.dateAndAction
      this.actual = reportData.transportSocialWelfareData.actual
      this.comment = reportData.transportSocialWelfareData.comment
    }
  }
}
</script>
