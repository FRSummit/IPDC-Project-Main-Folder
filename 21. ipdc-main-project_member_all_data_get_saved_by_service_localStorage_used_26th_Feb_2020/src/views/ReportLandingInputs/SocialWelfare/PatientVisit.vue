...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('socialWelfare_patientVisitSocialWelfarePlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('socialWelfare_patientVisitSocialWelfareData', JSON.stringify(post))
      }
    },
    backButton() {
      console.log('working')
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.patientVisitSocialWelfarePlanData.target
      this.dateAndAction = planData.patientVisitSocialWelfarePlanData.dateAndAction
    }
    if(tabActivationForPlanOrReport === 'REPORT') {
      ...
      this.target = reportData.patientVisitSocialWelfareData.target
      this.dateAndAction = reportData.patientVisitSocialWelfareData.dateAndAction
      this.actual = reportData.patientVisitSocialWelfareData.actual
      this.comment = reportData.patientVisitSocialWelfareData.comment
    }
  }
}
</script>
