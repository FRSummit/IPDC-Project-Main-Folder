...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('socialWelfare_foodDistributionSocialWelfarePlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('socialWelfare_foodDistributionSocialWelfareData', JSON.stringify(post))
      }
    },
    backButton() {
      console.log('working')
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.foodDistributionSocialWelfarePlanData.target
      this.dateAndAction = planData.foodDistributionSocialWelfarePlanData.dateAndAction
    }
    if(tabActivationForPlanOrReport === 'REPORT') {
      ...
      this.target = reportData.foodDistributionSocialWelfareData.target
      this.dateAndAction = reportData.foodDistributionSocialWelfareData.dateAndAction
      this.actual = reportData.foodDistributionSocialWelfareData.actual
      this.comment = reportData.foodDistributionSocialWelfareData.comment
    }
  }
}
</script>
