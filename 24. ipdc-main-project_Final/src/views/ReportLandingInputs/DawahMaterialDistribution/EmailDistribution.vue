...
export default {
  ...
  methods: {
    onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('dawahMaterialDistribution_emailDistributionMaterialPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('dawahMaterialDistribution_emailDistributionMaterialData', JSON.stringify(post))
      }
    },
    backButton() {
      console.log('working')
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.emailDistributionMaterialPlanData.target
      this.dateAndAction = planData.emailDistributionMaterialPlanData.dateAndAction
      ...
      this.target = reportData.emailDistributionMaterialData.target
      this.dateAndAction = reportData.emailDistributionMaterialData.dateAndAction
      this.actual = reportData.emailDistributionMaterialData.actual
      this.comment = reportData.emailDistributionMaterialData.comment
    }
  }
}
</script>
