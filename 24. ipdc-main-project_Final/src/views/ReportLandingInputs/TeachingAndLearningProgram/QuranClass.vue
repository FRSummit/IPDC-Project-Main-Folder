...
export default {
  ...
  methods: {
    onSubmit() {
      ...
      if(this.planOrReportTab === 'PLAN') {
        ...
        console.log(post)
        localStorage.setItem('teachingAndLearningProgram_quranClassTeachingLearningProgramPlanData', JSON.stringify(post))
        ...
        console.log(post)
        localStorage.setItem('teachingAndLearningProgram_quranClassTeachingLearningProgramData', JSON.stringify(post))
      }
      //
    },
    backButton() {
  ...
  created() {
    ...
    if(tabActivationForPlanOrReport === 'PLAN') {
      ...
      this.target = planData.quranClassTeachingLearningProgramPlanData.target
      this.dateAndAction = planData.quranClassTeachingLearningProgramPlanData.dateAndAction
    }
    if(tabActivationForPlanOrReport === 'REPORT') {
      ...
      this.target = reportData.quranClassTeachingLearningProgramData.target
      this.dateAndAction = reportData.quranClassTeachingLearningProgramData.dateAndAction
      this.actual = reportData.quranClassTeachingLearningProgramData.actual
      this.averageAttendance = reportData.quranClassTeachingLearningProgramData.averageAttendance
      this.comment = reportData.quranClassTeachingLearningProgramData.comment
    }
  }
}
</script>
