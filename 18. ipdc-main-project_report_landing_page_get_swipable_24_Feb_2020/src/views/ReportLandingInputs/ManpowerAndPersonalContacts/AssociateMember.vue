...
export default {
  ...
  created() {
      console.log(JSON.parse(localStorage.getItem('selected_plan_details')))
      let dataPlan = JSON.parse(localStorage.getItem('selected_plan_details'));
      let dataReport = JSON.parse(localStorage.getItem('selected_report_details'));
      console.log(dataPlan)
      console.log(dataReport)
      // let assiciativeData = data.associateMemberPlanData
      // console.log(assiciativeData) 
      this.lastPeriod = "",
      this.target = "",
      this.actual = "",
      this.increased = "",
